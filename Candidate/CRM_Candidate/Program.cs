...
using CRM_Candidate.Core.Extensions;
...
var connectionString = builder.Configuration.GetConnectionString("CRM_CandidateDBEntities");
...
builder.Services.AddScoped<DbContext, CandidateDBContext>();
